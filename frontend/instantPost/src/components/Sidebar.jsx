...
import { Camera, Grid, PlusCircle, Palette, Sun, Moon, ChevronLeft, ChevronRight, Settings, LogOut, Sparkles } from 'lucide-react';
        ...
        <div>
          ...
          >
            {!collapsed ? (
              ...
              <Link to="/feed" className="flex h-10 w-10 items-center justify-center rounded-xl theme-gradient text-white shadow-lg transition-transform duration-300 hover:scale-105">
            ...
            <button
              ...
              className={`absolute -right-3 top-7 h-6 w-6 rounded-full border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-md flex items-center justify-center text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 transition-all hover:scale-110`}
            >
            ...
            {!collapsed ? (
              <div className="flex items-center justify-between p-2 rounded-2xl bg-white/40 dark:bg-slate-900/40 border border-slate-200/10 dark:border-slate-800/10 group">
                ...
                <div className="flex gap-0.5">
                  <button className="p-1 rounded-lg text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 transition-colors" title="Settings">
                    <Settings className="h-3.5 w-3.5" />
                  </button>
                  <button className="p-1 rounded-lg text-slate-400 hover:text-rose-500 transition-colors" title="Logout">
